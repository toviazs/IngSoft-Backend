...
namespace AutorizacionAfipService
{
    ...
    public partial class UltimoComprobante : object
    {
        ...
        private AutorizacionAfipService.Comprobante[] ComprobantesField;
        
        private string ErrorField;
        
        [System.Runtime.Serialization.DataMemberAttribute()]
        public AutorizacionAfipService.Comprobante[] Comprobantes
        {
            get
            {
    ...
    public partial class SolicitudAutorizacion : object
    {
        ...
        private AutorizacionAfipService.TipoComprobante TipoComprobanteField;
        
        private AutorizacionAfipService.TipoDocumento TipoDocumentoField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public AutorizacionAfipService.TipoComprobante TipoComprobante
        {
            get
            {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public AutorizacionAfipService.TipoDocumento TipoDocumento
        {
            get
            {
    ...
    public partial class ResultadoSolicitudAutorizacion : object
    {
        ...
        private System.Nullable<AutorizacionAfipService.EstadoSolicitud> EstadoField;
        
        private string FechaDeVencimientoField;
        
        private string ObservacionField;
        
        private System.Nullable<AutorizacionAfipService.TipoComprobante> TipoComprobanteField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public System.Nullable<AutorizacionAfipService.EstadoSolicitud> Estado
        {
            get
            {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public System.Nullable<AutorizacionAfipService.TipoComprobante> TipoComprobante
        {
            get
            {
                return this.TipoComprobanteField;
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://ISTP1.Service.Contracts.Service", ConfigurationName="AutorizacionAfipService.ILoginService")]
    public interface ILoginService
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://ISTP1.Service.Contracts.Service/ILoginService/SolicitarAutorizacion", ReplyAction="http://ISTP1.Service.Contracts.Service/ILoginService/SolicitarAutorizacionRespons" +
            "e")]
        System.Threading.Tasks.Task<AutorizacionAfipService.Autorizacion> SolicitarAutorizacionAsync(string codigo);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://ISTP1.Service.Contracts.Service/ILoginService/SolicitarUltimosComprobantes" +
            ...
            "Response")]
        System.Threading.Tasks.Task<AutorizacionAfipService.UltimoComprobante> SolicitarUltimosComprobantesAsync(string token);
        ...
        System.Threading.Tasks.Task<AutorizacionAfipService.ResultadoSolicitudAutorizacion> SolicitarCaeAsync(string token, AutorizacionAfipService.SolicitudAutorizacion solicitud);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface ILoginServiceChannel : AutorizacionAfipService.ILoginService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class LoginServiceClient : System.ServiceModel.ClientBase<AutorizacionAfipService.ILoginService>, AutorizacionAfipService.ILoginService
    {
        ...
        public System.Threading.Tasks.Task<AutorizacionAfipService.Autorizacion> SolicitarAutorizacionAsync(string codigo)
        {
            return base.Channel.SolicitarAutorizacionAsync(codigo);
        }
        
        public System.Threading.Tasks.Task<AutorizacionAfipService.UltimoComprobante> SolicitarUltimosComprobantesAsync(string token)
        {
            return base.Channel.SolicitarUltimosComprobantesAsync(token);
        }
        
        public System.Threading.Tasks.Task<AutorizacionAfipService.ResultadoSolicitudAutorizacion> SolicitarCaeAsync(string token, AutorizacionAfipService.SolicitudAutorizacion solicitud)
        {
